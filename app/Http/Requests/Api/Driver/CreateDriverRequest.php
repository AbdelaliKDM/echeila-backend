...
class CreateDriverRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'cards.national_id.number.required' => 'National ID number is required.',
            'cards.national_id.number.unique' => 'This National ID number is already registered.',
            ...
            'cards.driving_license.number.required' => 'Driving license number is required.',
            'cards.driving_license.number.unique' => 'This driving license number is already registered.',
